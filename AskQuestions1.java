...
public class AskQuestions1 extends javax.swing.JFrame {
...
int totalMarks=0;
    ...
    public AskQuestions1(String CatagoriesArray[]) throws InterruptedException {
        initComponents();
...
//             
             DAO DAOObj = new DAO();
             DataGet=DAOObj.questionfetch(CatagoriesArray[0],1);
    ...
    try {
        ...
        dispose();
        AskQuestions2 obj= new AskQuestions2(CatagoriesArrayData,totalMarks);
        obj.setVisible(true);
    } catch (InterruptedException ex) {
        Logger.getLogger(AskQuestions1.class.getName()).log(Level.SEVERE, null, ex);
    }
...
//        System.out.println(l);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AskQuestions1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
