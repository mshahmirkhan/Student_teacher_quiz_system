 ...
 * @author shahmirkhan
 */
public class AskQuestions9 extends javax.swing.JFrame {
...
int totalMarks;
    ...
    public AskQuestions9(String CatagoriesArray[], int totalMarks) throws InterruptedException {
        initComponents();
...
//             
             DAO DAOObj = new DAO();
             DataGet=DAOObj.questionfetch(CatagoriesArray[2],2);
    ...
    try {
        ...
        dispose();
        AskQuestions10 obj= new AskQuestions10(CatagoriesArrayData,totalMarks);
        obj.setVisible(true);
    } catch (InterruptedException ex) {
        Logger.getLogger(AskQuestions9.class.getName()).log(Level.SEVERE, null, ex);
    }
...
//        System.out.println(l);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AskQuestions9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
