 ...
 * @author shahmirkhan
 */
public class AskQuestions10 extends javax.swing.JFrame {
...
int totalMarks;
    ...
    public AskQuestions10(String CatagoriesArray[], int totalMarks) throws InterruptedException {
        initComponents();
...
//             
             DAO DAOObj = new DAO();
             DataGet=DAOObj.questionfetch(CatagoriesArray[2],3);
    ...
    private void doneActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_doneActionPerformed
        ...
        dispose();
        ViewResult obj= new ViewResult(CatagoriesArrayData,totalMarks);
        obj.setVisible(true);
...
//        System.out.println(l);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AskQuestions10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
