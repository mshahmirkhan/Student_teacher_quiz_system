 ...
 * @author shahmirkhan
 */
public class AskQuestions5 extends javax.swing.JFrame {
...
int totalMarks;
    ...
    public AskQuestions5(String CatagoriesArray[], int totalMarks) throws InterruptedException {
        initComponents();
...
//             
             DAO DAOObj = new DAO();
             DataGet=DAOObj.questionfetch(CatagoriesArray[1],2);
    ...
    try {
        ...
        dispose();
        AskQuestions6 obj= new AskQuestions6(CatagoriesArrayData,totalMarks);
        obj.setVisible(true);
    } catch (InterruptedException ex) {
        Logger.getLogger(AskQuestions5.class.getName()).log(Level.SEVERE, null, ex);
    }
...
//        System.out.println(l);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AskQuestions5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
