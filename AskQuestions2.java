 ...
 * @author shahmirkhan
 */
public class AskQuestions2 extends javax.swing.JFrame {
...
int totalMarks;
    ...
    public AskQuestions2(String CatagoriesArray[], int totalMarks) throws InterruptedException {
        initComponents();
...
//             
             DAO DAOObj = new DAO();
             DataGet=DAOObj.questionfetch(CatagoriesArray[0],2);
    ...
    try {
        ...
        dispose();
        AskQuestions3 obj= new AskQuestions3(CatagoriesArrayData,totalMarks);
        obj.setVisible(true);
    } catch (InterruptedException ex) {
        Logger.getLogger(AskQuestions2.class.getName()).log(Level.SEVERE, null, ex);
    }
...
//        System.out.println(l);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AskQuestions2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
