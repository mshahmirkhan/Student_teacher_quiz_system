 ...
 * @author shahmirkhan
 */
public class AskQuestions4 extends javax.swing.JFrame {
...
int totalMarks;
    ...
    public AskQuestions4(String CatagoriesArray[], int totalMarks) throws InterruptedException {
        initComponents();
...
//             
             DAO DAOObj = new DAO();
             DataGet=DAOObj.questionfetch(CatagoriesArray[1],1);
    ...
    try {
        ...
        dispose();
        AskQuestions5 obj= new AskQuestions5(CatagoriesArrayData,totalMarks);
        obj.setVisible(true);
    } catch (InterruptedException ex) {
        Logger.getLogger(AskQuestions4.class.getName()).log(Level.SEVERE, null, ex);
    }
...
//        System.out.println(l);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AskQuestions4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
