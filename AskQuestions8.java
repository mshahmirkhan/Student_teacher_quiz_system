 ...
 * @author shahmirkhan
 */
public class AskQuestions8 extends javax.swing.JFrame {
...
int totalMarks;
    ...
    public AskQuestions8(String CatagoriesArray[], int totalMarks) throws InterruptedException {
        initComponents();
...
//             
             DAO DAOObj = new DAO();
             DataGet=DAOObj.questionfetch(CatagoriesArray[2],1);
    ...
    try {
        ...
        dispose();
        AskQuestions9 obj= new AskQuestions9(CatagoriesArrayData,totalMarks);
        obj.setVisible(true);
    } catch (InterruptedException ex) {
        Logger.getLogger(AskQuestions8.class.getName()).log(Level.SEVERE, null, ex);
    }
...
//        System.out.println(l);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AskQuestions8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
