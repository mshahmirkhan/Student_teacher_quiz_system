 ...
 * @author shahmirkhan
 */
public class AskQuestions7 extends javax.swing.JFrame {
...
int totalMarks;
    ...
    public AskQuestions7(String CatagoriesArray[], int totalMarks) throws InterruptedException {
        initComponents();
...
//             
             DAO DAOObj = new DAO();
             DataGet=DAOObj.questionfetch(CatagoriesArray[1],4);
    ...
    try {
        ...
        dispose();
        AskQuestions8 obj= new AskQuestions8(CatagoriesArrayData,totalMarks);
        obj.setVisible(true);
    } catch (InterruptedException ex) {
        Logger.getLogger(AskQuestions7.class.getName()).log(Level.SEVERE, null, ex);
    }
...
//        System.out.println(l);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AskQuestions7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
