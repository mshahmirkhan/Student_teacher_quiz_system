 ...
 * @author shahmirkhan
 */
public class AskQuestions6 extends javax.swing.JFrame {
...
int totalMarks;
    ...
    public AskQuestions6(String CatagoriesArray[], int totalMarks) throws InterruptedException {
        initComponents();
...
//             
             DAO DAOObj = new DAO();
             DataGet=DAOObj.questionfetch(CatagoriesArray[1],3);
    ...
    try {
        ...
        dispose();
        AskQuestions7 obj= new AskQuestions7(CatagoriesArrayData,totalMarks);
        obj.setVisible(true);
    } catch (InterruptedException ex) {
        Logger.getLogger(AskQuestions6.class.getName()).log(Level.SEVERE, null, ex);
    }
...
//        System.out.println(l);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AskQuestions6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
